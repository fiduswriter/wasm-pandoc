...
/**
 * Test script for non-ASCII file names in wasm-pandoc
 *
 * This test verifies that wasm-pandoc correctly handles file names containing
...
console.log("Testing non-ASCII file names in wasm-pandoc...\n")
...
@article{山田2024,
  ...
  year = {2024}
        ...
        console.log("\nwasm-pandoc correctly handles non-ASCII file names from")
